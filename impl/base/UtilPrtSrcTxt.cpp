...
void UtilPrtSrcTxt::printStmt(ASTContext &Ctx, CompilerInstance &CI, std::string tag, std::string title, const clang::Stmt *stmt,
...
void UtilPrtSrcTxt::printExpr(ASTContext &Ctx, CompilerInstance &CI, std::string tag, std::string title, clang::Expr *expr,
                     bool printSourceText) {
...
void UtilPrtSrcTxt::printDecl(ASTContext &Ctx, CompilerInstance &CI, std::string tag, std::string title, clang::Decl *decl,
                     bool printSourceText) {
...
void  UtilPrtSrcTxt::printSourceRange(int64_t nodeID,
        CompilerInstance& CI,
...
void  UtilPrtSrcTxt::printSourceRangeSimple(
                             CompilerInstance& CI,
                             std::string tag, std::string title,
